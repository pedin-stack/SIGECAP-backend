package br.com.ifba.person.controller;

import br.com.ifba.person.DTO.PersonRequestDTO;
import br.com.ifba.person.DTO.PersonResponseDTO;
import br.com.ifba.address.entity.Address;
import br.com.ifba.person.entity.Person;
import br.com.ifba.person.service.PersonService;
...
public class PersonController {
    ...
    @GetMapping
    public ResponseEntity<Page<PersonResponseDTO>> findAll(@PageableDefault(size = 20) Pageable pageable) {
        return ResponseEntity.ok(personService.findAll(pageable).map(this::toDto));
    }
